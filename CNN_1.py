...
batch_reduction = 25
batch_size_list = list(reversed(range(25,175,batch_reduction)))
...
for it in range(5):
    ...
    for batch_size in batch_size_list:
        ...
        for lr in lr_list:
            ...
            if abs(test_accuracy-last_test_accuracy)<=0.01 and last_test_accuracy >= 0.9:
        ...
        if abs(batch_accuracy-last_batch_accuracy)<=0.01 and last_batch_accuracy>=0.95:
    ...
    image_name = "Validation_it_"+str(it)+".png"
    ...
    image_name = "Train_it_"+str(it)+".png"
